// 修正了光晕后处理在clearColor透明情况下出现的bug
...
class TransparentBackgroundFixedUnrealBloomPass extends Pass {
  ...
  resolution: Vector2;
  clearColor: Color;
  renderTargetsHorizontal: (WebGLRenderTarget | WebGLMultipleRenderTargets | null)[];
  ...
  render (renderer: WebGLRenderer, writeBuffer: unknown, readBuffer: { texture: Texture; }, deltaTime: unknown, maskActive: unknown) {
